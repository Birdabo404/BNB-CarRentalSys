          ...
          <div className="max-w-6xl mx-35 px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                ...
                {/*There's a bloody bug where some components goes over the Navbar! -help*/}
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold mb-4">Your Dream Car in 4 Easy Steps</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
              We’ve smoothed out every step so you can grab your keys and go – safely and without fuss.
                <br />
                Just follow these quick tips to start your Butuan adventure!
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12 relative">
              ...
              <div className="relative z-10">
                <div className="bg-purple-50 rounded-xl p-8 h-full">
                  ...
                  <p className="text-gray-600 text-center">Choose your rental duration.</p>
                  <div className="flex justify-center mt-6">
                    <CheckCircle className="w-6 h-6 text-gray-300" />
                  </div>
                </div>
              ...
              <div className="relative z-10">
                <div className="bg-orange-50 rounded-xl p-8 h-full">
                  ...
                  <p className="text-gray-600 text-center">Quick and secure payment.</p>
                  <div className="flex justify-center mt-6">
                    <CheckCircle className="w-6 h-6 text-gray-300" />
                  </div>
                </div>
            ...
            <div className="flex justify-center mt-12">
              <Button className="bg-[#FF6B35] hover:bg-[#FF5722] text-white px-8 py-6 rounded-lg transition-transform duration-300 hover:scale-105 h-auto">
                Book a Car Now<ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </div>
          </div>
        </section>
